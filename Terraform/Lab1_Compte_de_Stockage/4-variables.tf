...
variable "storageAccountBackendTerraform" {
  type    = string
  default = "loic2456" # IMPORTANT mettre ici un nom unique. cf https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-naming#example-names-storage
}
